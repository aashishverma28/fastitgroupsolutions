        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="space-y-4">
              <Link href="/admin/services" className="flex items-center justify-between p-6 rounded-[30px] bg-white/[0.03] border border-white/5 hover:bg-white hover:text-black transition-all group">
              ...
              <Link href="/admin/board" className="flex items-center justify-between p-6 rounded-[30px] bg-white/[0.03] border border-white/5 hover:bg-white hover:text-black transition-all group">
                <div className="flex items-center gap-5">
              ...
              <Link href="/admin/demos" className="flex items-center justify-between p-6 rounded-[30px] bg-white/[0.03] border border-white/5 hover:bg-white hover:text-black transition-all group">
                <div className="flex items-center gap-5">
