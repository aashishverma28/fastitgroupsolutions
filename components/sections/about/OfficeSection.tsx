...
export function OfficeSection() {
  ...
  return (
    <section id="offices" className="bg-[#FAF9F7] py-[140px] px-6 md:px-20 relative overflow-hidden">
      {/* Decorative text background */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-display font-black text-[200px] md:text-[400px] text-black/[0.02] whitespace-nowrap pointer-events-none select-none z-0">
        DERGAON
      </div>
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-[700px] mb-20">
          ...
          <h2 className="font-display font-extrabold text-[48px] md:text-[72px] text-[#0A0A0A] leading-tight mb-8">
            Two offices.<br />One town.
          </h2>
          <p className="font-satoshi text-[18px] text-[#555555] leading-relaxed">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Office 1 */}
          <div className="office-card group bg-white rounded-3xl p-10 md:p-12 shadow-[0_20px_80px_rgba(0,0,0,0.04)] border border-black/5 hover:border-[#E8156D]/20 transition-all duration-500">
            ...
            <h3 className="font-display font-bold text-[28px] text-[#0A0A0A] mb-4">Near Bapuji Mandir</h3>
            <p className="font-satoshi text-[16px] text-[#666666] leading-relaxed mb-8">
              Ward No. 04, Near Bapuji Mandir,<br />
              Dergaon, Dist. Golaghat,<br />
              Assam, 785614
            </p>
            <div className="flex items-center gap-2 font-satoshi font-semibold text-[14px] text-[#0A0A0A] group-hover:text-[#E8156D] transition-colors">
              <span>Main Hub</span>
          ...
          {/* Office 2 */}
          <div className="office-card group bg-white rounded-3xl p-10 md:p-12 shadow-[0_20px_80px_rgba(0,0,0,0.04)] border border-black/5 hover:border-[#E8156D]/20 transition-all duration-500">
            <div className="w-12 h-12 bg-[#0A0A0A] rounded-xl flex items-center justify-center mb-8 shadow-lg shadow-black/20">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="block font-satoshi font-bold text-[13px] text-gray-400 uppercase tracking-widest mb-2">Registered Office</span>
            <h3 className="font-display font-bold text-[28px] text-[#0A0A0A] mb-4">Rangamamati</h3>
            <p className="font-satoshi text-[16px] text-[#666666] leading-relaxed mb-8">
